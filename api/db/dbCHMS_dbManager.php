...
function getConnection() {
	...
	global $db_CHMS_db_Url, $db_CHMS_db_User, $db_CHMS_db_Pass, $db_CHMS_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_CHMS_db_Url.";dbname=".$db_CHMS_db_DbName, $db_CHMS_db_User, $db_CHMS_db_Pass);
